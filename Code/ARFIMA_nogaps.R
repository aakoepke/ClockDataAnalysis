########## ARFIMA(0,d,0) process simulations #######


###trying out the spectral vs. AVAR approach on an ARFIMA(0,d,0) process
### with d < 0.5 
...
saveRDS(tmat,paste("Results/tmat",runDate,"_W",setWnum,"_K",setK,"_N",N,"_",numberOfSimulations,"sims_ARFIMANoGaps.Rds",sep=""))
saveRDS(bmat,paste("Results/bmat",runDate,"_W",setWnum,"_K",setK,"_N",N,"_",numberOfSimulations,"sims_ARFIMANoGaps.Rds",sep=""))
saveRDS(amat,paste("Results/amat",runDate,"_N",N,"_",numberOfSimulations,"sims_ARFIMANoGaps.Rds",sep=""))
saveRDS(oamat,paste("Results/oamat",runDate,"_N",N,"_",numberOfSimulations,"sims_ARFIMANoGaps.Rds",sep=""))
